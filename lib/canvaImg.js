...
const createWelcomeImage = async (profilePicUrl) => {
    ...
    ctx.fillRect(100, 80, canvas.width - 200, canvas.height - 180); // Mover el rectángulo hacia arriba
    ...
    const circleY = 350; // Mover la imagen de perfil hacia arriba
    ...
    ctx.fillText('¡Bienvenido al grupo!', canvas.width / 2, 540);
    ...
    ctx.fillText('NyanBotV2 te da la bienvenida', canvas.width / 2, 670);
