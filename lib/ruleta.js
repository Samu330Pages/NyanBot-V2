...
const crearRuletaGif = () => {
    ...
    const drawLights = () => {
        ...
        for (let i = 0; i < lightCount; i++) {
            ...
            ctx.fill();
            ctx.shadowBlur = 10; // Efecto de desenfoque
    ...
    const drawArrow = () => {
        ctx.fillStyle = "black"; 
        ctx.beginPath();
        ctx.moveTo(200 - 6, 200 - (outsideRadius + 15)); 
        ctx.lineTo(200 + 6, 200 - (outsideRadius + 15));
        ctx.lineTo(200 + 6, 200 - (outsideRadius - 5));
        ctx.lineTo(200 + 12, 200 - (outsideRadius - 5));
        ctx.lineTo(200 + 0, 200 - (outsideRadius - 20)); // Aumentar el tamaño de la flecha
        ctx.lineTo(200 - 12, 200 - (outsideRadius - 5));
        ctx.lineTo(200 - 6, 200 - (outsideRadius - 5));
        ctx.lineTo(200 - 6, 200 - (outsideRadius + 15));
        ctx.fill();
