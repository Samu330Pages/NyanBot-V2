...
const crearRuletaVideo = () => {
    ...
    ffmpegCommand.on('end', () => {
        ...
        // Devolver el buffer y el resultado
        return { buffer, resultado, creador: "Samu330 🎡" };
    });

    // Escribir los cuadros en el flujo de salida
...
// Ejemplo de uso
// crearRuletaVideo().then(({ buffer, resultado, creador }) => {
//     // Aquí puedes usar el buffer del video y el resultado
// });
